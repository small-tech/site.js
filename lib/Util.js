...
class Util {
  ...
  static unprivilegedHomeDirectory () {
    if (process.platform === 'win32') {
      ...
      // On immutable systems like Fedora Silverblue, we cannot assume that
      // the home directory is going to be off of /home. It can also be in
      // /var, etc. Check for that.
      const root = homeDir.match(pathPrefixRegex)[1]
      return `${root}/${accountsFolder}/${Util.unprivilegedAccountName()}`
    }
  }
